...
test_that('it should return negative bizdays', {
  ...
  expect_equal(
    bizdays(c('2013-08-21', '2013-01-31', '2013-01-01'),
...
test_that("is should compute negative bizdays for non finacial calendars", {
  ...
  expect_equal(-bizdays('2014-07-12', '2013-07-12', "actual-no-fin"),
...
test_that('it should bizdays NA values', {
  expect_equal(bizdays('2013-01-01', c('2013-12-31', '2014-12-31', NA)),
               c(364, 729, NA))
  expect_equal(adjust.next(c('2013-12-31', '2014-12-31', NA)),
               as.Date(c('2013-12-31', '2014-12-31', NA)))
  expect_equal(adjust.previous(c('2013-12-31', '2014-12-31', NA)),
               as.Date(c('2013-12-31', '2014-12-31', NA)))
